...
// matches <foo>...</foo> extracts content
  ...
  function write_w3cdtf (d, t) {
    try { return d.toISOString().replace(/\.\d*/, '') } catch (e) { if (t) throw e }
    return ''
  }
...
//var VT_ARRAY    = 0x2000;
  ...
  function write_ext_props (cp) {
    ...
    o[o.length] = (W('TitlesOfParts', W('vt:vector', cp.SheetNames.map(function (s) { return '<vt:lpstr>' + escapexml(s) + '</vt:lpstr>' }).join(''), {
      size: cp.Worksheets,
      baseType: 'lpstr'
    })))
    if (o.length > 2) {
